...
function SignInContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-150 pointer-events-none opacity-20">
        <div className="absolute inset-0 bg-linear-to-b from-accent-purple/30 via-accent-blue/15 to-transparent rounded-full blur-3xl" />
      </div>
      <div className="absolute bottom-0 right-0 w-96 h-96 pointer-events-none opacity-10">
        <div className="absolute inset-0 bg-linear-to-t from-accent-cyan/20 to-transparent rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        {/* Error message */}
        {errorMessage && (
          <div className="mb-6 p-4 rounded-xl bg-error/10 border border-error/20 animate-slide-down">
        ...
        <div className="text-center mt-6">
          <a
            href="/"
            className="text-sm text-text-muted hover:text-text-secondary transition-colors inline-flex items-center gap-1.5"
          >
            <svg
              className="w-4 h-4"
              fill="none"
